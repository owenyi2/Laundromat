...
class Trader:
    def _compute_sma(self, prices: list, period: int) -> list:
    ...
    def _compute_sma_responsive(self, prices: list, period: int) -> list:
        if not prices or period <= 0 or period > len(prices):
            return -1
    ...
    def _compute_ema(self, state: TradingState) -> list:
        avgs = []
        return avgs
