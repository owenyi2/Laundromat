...
class Trader:
    ...
    def compute_starfruit_order(self, state: TradingState) -> list[Order]:
        ...
        # print( best_bid_vol, best_ask_vol, best_ask_pr)
    ...
    def parse_trader_data(self, state: TradingState):
        if state.traderData == '':
            ...
            self.traderData = {"STARFRUIT": {"previous_ask": 1e9, "previous_bid": -1e9, "previous_ask_vol": -1, "previous_bid_vol": 1, "KF_state": jsonpickle.encode((x, P))}}
        else:
